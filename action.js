...
function openlink(x) {
    if (x == 1) {
        window.open("https://www.instagram.com/myself_rittika_67?igsh=djFqaHRqaDMzM2Zk", "_blank");
    }
    if (x == 2) {
        window.open("https://www.facebook.com/profile.php?id=100071396447409&mibextid=ZbWKwL", "_blank");
    }
    if (x == 3) {
        window.open("", "_blank");
    }
...
document.addEventListener("DOMContentLoaded", function() {   
    var fadeComplete = function(e) { 
        ...
        stage.appendChild(arr[0]); // Move the first element to the end
    };    
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    button.addEventListener('click', function() {
        ...
        // Hide the overlays after 5 seconds
        setTimeout(function() {
